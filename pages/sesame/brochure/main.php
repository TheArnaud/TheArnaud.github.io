...
<?php
	include('pages/sesame/brochure/menu.php');
?>
	<div id="ssm-gauche">
		<p>
			Veuillez remplir le formulaire suivant afin de recevoir notre brochure concernant notre préparation aux concours Sésame/Accès.
		<br><br>
		...
		<form method='post' action='modules/mail.php'>
			<fieldset>
				...
				<input type="hidden" name="dest" value="contact@pc-es.fr" />
