<div id="corps">
	<div id="titre">
		Inscriptions SESAME ACCES<span style="float:right; margin-right:20px;">97% d'admis</span>
	</div>
...
?>
  ...
  <div class="container">
	...
	<div id="acm-droite" style="text-align:center">
		<img src="img/resultat17.jpg" alt="" style="position:relative; top:120px"/>
	</div>
	</div>
	</div>
</div>
